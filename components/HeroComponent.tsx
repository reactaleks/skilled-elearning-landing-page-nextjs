  ...
  return (
    <div className="">
      ...
      <div className="lg:mx-auto md:overflow-hidden md:grid md:grid-cols-2 ">
        <div className="flex flex-col px-4 md:px-0 pt-16 md:pt-0 mx-auto 
        max-w-[375px] md:max-w-[344.5px] xl:max-w-[550px] 
        md:mx-0 md:ml-auto justify-center md:justify-start md:mt-32 lg:mt-48 xl:mt-64">
          <h1 className="text-headingl leading-headingl xl:text-headingxl xl:leading-headingxl font-jakarta font-extrabold mt-6">
            Maximize skill, minimize budget
          </h1>
          <p className="mt-6 text-mainm text-gray leading-main">
